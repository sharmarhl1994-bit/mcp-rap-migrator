...
export async function callLLM(userPrompt, systemOverride, maxTokens = 8000 // increased for code generation
) {
    ...
    const result = await callAICore([{ role: "user", content: userPrompt }], system, maxTokens);
