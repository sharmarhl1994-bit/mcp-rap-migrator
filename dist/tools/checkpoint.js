 ...
 */
export async function humanCheckpoint(args) {
    ...
    lines.push("", divider, "💬  REPLY WITH:", "  YES            — proceed with next action", "  MODIFY <text>  — change something first", "  ABORT          — stop migration", divider);
    return {
        content: [{
                type: "text",
                text: lines.join("\n"),
